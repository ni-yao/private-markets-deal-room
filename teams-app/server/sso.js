...
//
// SECURITY: this decodes the JWT payload WITHOUT verifying its signature, issuer,
// or audience — so the returned identity is NOT trustworthy for authorization.
// It is used only to derive a display persona/role in a no-login demo app; do not
// gate protected data on it. For production, validate the token against the Entra
// JWKS (iss/aud/exp/tid) before trusting any claim. We at least reject expired
// tokens here to avoid trivially stale identities.
